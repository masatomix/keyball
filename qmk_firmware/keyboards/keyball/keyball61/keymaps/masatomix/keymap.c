...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_PSCR  , MO(4)    , KC_LGUI  , KC_LALT  , LT(1,KC_LNG1), LT(2,KC_SPC), LT(3,KC_LNG2),  LT(1,KC_BSPC) , LT(2,KC_ENT), LT(1,KC_LNG2),KC_RGUI , _______ ,MO(4) , LT(3,KC_GRAVE)
  ),
  ...
  [1] = LAYOUT_universal(
   ...
   S(KC_LCTL), _______    , _______       , KC_DEL    , KC_RGHT  , _______  ,                           KC_BSPC  , _______  , _______   , _______  , KC_LEFT   , KC_RGHT ,
    _______  , KC_BTN4    , KC_BTN5       , KC_PGDN   , KC_DOWN  , KC_LEFT  , _______  ,     _______  , KC_DOWN  , _______  , _______   , KC_PGDN  , KC_DOWN   , _______ ,
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , KC_VOLD  , KC_VOLU  , KC_LEFT  , KC_RGHT  , _______  ,                                  _______  , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_LEFT  , KC_RGHT  ,
    _______  , KC_BTN4  , KC_BTN5  , _______  , KC_DOWN  , KC_LEFT  , _______  ,            _______  , _______  , KC_BTN4  , _______  , KC_BTN5  , KC_DOWN  , _______  ,
