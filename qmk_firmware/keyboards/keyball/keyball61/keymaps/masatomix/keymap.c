...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , KC_PGUP  , KC_UP  , LGUI(KC_ESC)  ,                                  _______  , _______  , _______  , _______  , KC_UP    , _______  ,
    _______  , _______  , _______  , KC_DEL   , KC_RGHT  , _______  ,                                  KC_BSPC  , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_LEFT  , KC_RGHT  ,
    _______  , _______  , _______  , KC_PGDN  , KC_DOWN  , KC_LEFT  , _______  ,            _______  , KC_DOWN  , KC_BTN4  , _______  , KC_BTN5  , KC_DOWN  , _______  ,
